	...
	*/
	...
	var drawImg = function () {
		function drawImg(ctx, imgInfo, config, canvasInfo) {
			...
			var p = this;
			p.ctx = ctx;
			p.imgInfo = imgInfo, p.img = imgInfo.el;
	...
	var bubble = new JumpBubble(document.getElementById("canvasIdName"));
